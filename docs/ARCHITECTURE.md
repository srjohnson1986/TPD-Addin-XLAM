...
| Module | Purpose |
|---|---|
| `modHelpers_Workbook` | Sheet/workbook utilities: first visible sheet, create-or-clear a sheet by name, next available sheet name, last-row/last-column lookups, and `IsWorkbookOpen(fileName)`. |
