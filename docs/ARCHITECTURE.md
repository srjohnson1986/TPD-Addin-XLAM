...
| `modPreferences_KeyMap` | Central list of every preference key (`PREF_EQLIST_COLUMNS`, `PREF_SPLIT_GROUPCOL`, `PREF_SPLIT_COLUMNS`, `PREF_VERSION`) so keys never float as loose string literals. |
