...
'============================================================
' ExportAllVBAModules2 - drop-in replacement for the existing
' ExportAllVBAModules in modHelpers_Diagnostics.
'
' Paste this below the existing SheetExists2 function (leave
' the old ExportAllVBAModules in place until you've verified
' this one works, then delete it).
'
